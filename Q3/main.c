...
static void response(esp_mqtt_event_handle_t event)
{   
    ...
    esp_mqtt_client_publish(event->client, "SIOT/response", data, 0, 1, 0);
    // Controlling the LED
    control_LED(data);
}
...
{   
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        // Subscribing to the 'SIOT/LED' topic
...
static void mqtt_app_start(void)
{
    ...
    esp_mqtt_client_config_t mqtt_cfg = {
        ...
        // Setting the username and password of the ESP32 user
        .credentials.username = "ESP32",
        .credentials.authentication.password = "esp32123",
    };
